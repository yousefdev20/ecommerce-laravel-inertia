            ...
            <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
                ...
                <div>
                    <div class="mt-10">
                        ...
                        <NavLink href="/products" class="inline-block rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-center font-medium text-white hover:bg-indigo-700 dark:hover:text-white pt-3">Shop Collection</NavLink>
                    </div>
                </div>
            </div>
        </div>
