<template>
    <NavbarLayout title="Checkout">
        <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32 mt-5">
        <div class="px-4 pt-8">
            <p class="text-xl font-medium">Order Summary</p>
            <p class="text-gray-400">Check your items. And select a suitable shipping method.</p>
            <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
                <div class="flex flex-col rounded-lg bg-white sm:flex-row" v-for="(product, key) in products" :key="key">
                    ...
                    <div class="flex w-full flex-col px-4 py-4">
                        ...
                        <p class="text-lg font-bold">Qty: {{ product.quantity }}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
            ...
            <div class="">
                ...
                <div class="relative">
                    <input type="text" id="email" name="email"
                           ...
                           placeholder="your.email@gmail.com" :value="user?.email"/>
            ...
            <button class="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">Place Order
            </button>
        </div>
    </div>
    </NavbarLayout>
